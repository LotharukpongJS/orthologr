...
#' @description Some annotation files include lines with character lengths greater than 65000. This causes problems when trying to import such annotation files into R using \href{https://rdrr.io/bioc/rtracklayer/man/export.html}{import}.
#' To overcome this issue, this function screens for such lines
#' in a given annotation file and removes these lines so that
#' \href{https://rdrr.io/bioc/rtracklayer/man/export.html}{import} can handle the file.
